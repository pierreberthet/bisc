...
z_cell_pos = np.ones(n_cells) * -dura_height
...
max_current = 100 * 10**3   # mA
min_current = .1 * 10**3
current_resolution = 200
...
if cell_id == 0:
    ...
    # cb.set_ticks(tick_locations)
    # cb.set_label('mV', labelpad=-10)
    plt.savefig("selectivity_sticks_fig1.png")
    ...
    if max_current < 0:
        plt.gca().invert_yaxis()
    plt.legend(loc="upper left")
    plt.savefig("selectivity_sticks_fig2.png", dpi=300)
