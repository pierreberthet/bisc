...
#define castate castate__cah 
#define evaluatefct evaluatefct__cah 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cah /media/erebus/oslo/code/darpa/bisc/morphologies/almog/x86_64/ca_h.mod\n");
