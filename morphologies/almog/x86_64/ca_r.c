...
#define castate castate__car 
#define evaluatefct evaluatefct__car 
...
extern "C" {
 ...
 static void _hoc_evaluatefct(void);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 car /media/erebus/oslo/code/darpa/bisc/morphologies/almog/x86_64/ca_r.mod\n");
...
static int evaluatefct(_threadargsprotocomma_ double);
...
static int  evaluatefct ( _threadargsprotocomma_ double _lv ) {
